...
Using the above information, get the first search result, generate a concise and relevant anime recommendation. If no exact match is found, suggest the closest relevant anime.
    `,
  })
